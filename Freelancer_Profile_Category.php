  ...
  include('DBConn.php');?>
    ...
    <section id="event-page" class="pt-90 pb-120 gray-bg">
	  ...
	  $category=$_GET['category'];
		$query=mysqli_query($TuneMaster,"select * from members left join profile_deep on members.Member_id = profile_deep.Member_id where   category  = '$category' ")or die(mysqli_error());
